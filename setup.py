...
if not SKIP_CUDA_BUILD:
    ...
    ext_modules.append(
        CUDAExtension(
            name="online_selective_scan_cuda",
            sources=[
                "csrc/selective_scan/online_selective_scan.cpp",
                "csrc/selective_scan/selective_scan_online_fwd.cu",
                "csrc/selective_scan/selective_scan_online_bwd.cu",
            ],
            extra_compile_args={
                "cxx": ["-O3", "-std=c++17"],
    ...
    ext_modules.append(
        CUDAExtension(
            ...
            include_dirs=[os.path.join(this_dir, "csrc/layer_norm")],
        )
    )
    ext_modules.append(
       CUDAExtension(
...
setup(
    ...
    author="Bo Liu, Rui Wang, Tri Dao, Albert Gu",
    author_email="bliu@cs.utexas.edu",
    description="Longhorn and Mamba state-space model",
